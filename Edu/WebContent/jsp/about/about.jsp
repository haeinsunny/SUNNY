    ...
    <section class="page-section" id="about">
        <div class="container">
            <div class="text-center">
                ...
                <h3 class="section-subheading text-muted">EduAll</h3>
            </div>
            <ul class="timeline">
                <li>
                    ...
                    <div class="timeline-panel">
                        <div class="timeline-heading">
                            <h4 class="subheading">수 많은 학원, 여기서 찾으세요!</h4>
                        </div>
                        <div class="timeline-body">
                            <p class="text-muted">간편조회로 전국 시도별 학원을 볼 수 있습니다.</p>
                        </div>
                    </div>
                </li>
                <li class="timeline-inverted">
                    ...
                    <div class="timeline-panel">
                        <div class="timeline-heading">
                            <h4 class="subheading">상담까지 바로 신청 해보세요.</h4>
                        </div>
                        <div class="timeline-body">
                            <p class="text-muted">학원 상세페이지에서 상담신청이 가능합니다. 부담없이 신청해보세요!</p>
                        </div>
                    </div>
                </li>
                <li>
